                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <p class="mb-2">Accepted Orders</p>
                                        <h5>0{{ $acceptedOrders }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <p class="mb-2">Orders (COD)</p>
                                        <h5>0{{ $totalOrdersCodCount }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <p class="mb-2">Orders (Card)</p>
                                        <h5>0{{ $totalOrdersCardCount }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <p class="mb-2">Sales through COD </p>
                                        <h5>AED {{ $totalAmountReceivedCashOnDelivery }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <p class="mb-2">Sales through Card </p>
                                        <h5>AED {{ $totalAmountReceivedCard }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
