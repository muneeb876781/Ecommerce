    ...
    <div class="content-start transition  ">
        <div class="container-fluid dashboard">
            <div class="content-header">
                ...
                <button id="showAllCategoriesBtn" class="btn btn-primary">ALL Sub Categories</button>
                <button id="showAddCategoryFormBtn" class="btn btn-primary">Add Sub Category</button>
                <br>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($subCategory as $subCategories)
                                            <tr>
                                                ...
                                                <td style="width: 15%">{{ $subCategories->name}}</td>
                                                <td style="width: 40%">{{ $subCategories->category->name}}</td>
                                                <td style="width: 20%">
                                                    <a class="btn btn-link text-primary" href="#"
                                                        title="View Details" data-bs-toggle="modal"
                                                        data-bs-target="#categoryDetailsModal"
                                                        onclick="showCategoryDetails('{{ $subCategories->name }}', '{{ $subCategories->description }}')">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a class="btn btn-link text-warning" href="#" title="Edit"
                                                        data-bs-toggle="modal" data-bs-target="#editCategoryModal"
                                                        onclick="prepareEditCategoryModal('{{ $subCategories->id }}', '{{ $subCategories->name }}', '{{ $subCategories->description }}')">
                                                    ...
                                                    <a class="btn btn-link text-warning" href="#" title="Edit">
                                                        <form style="display: inline"
                                                            action="{{ route('categorydestroy', ['id' => $subCategories->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button
                ...
                <div id="addCategoryForm" class="row" style="display: none">
                    <form class="main_form" action="{{ route('storesubCategories') }}" method="post"
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="subCategoriesName">Sub Categories Name:</label>
                                            <input class="form-control" type="text" id="subCategoriesName"
                                                name="subCategoriesName" placeholder="Enter Sub Categories Name">
                                        </div>
                                        <div class="mb-3">
