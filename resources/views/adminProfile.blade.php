...
<body>
    ...
    <div class="content-start transition">
        <div class="container-fluid dashboard">
            ...
            <div class="row">
                <div class="card">
                    <form action="{{ route('editShop', ['id' => $admin->id]) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf

                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center  ">
                                <img src="{{ asset('storage/uploads/' . $admin->logo) }}" alt=""
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label for="firstName" class="form-label">Amin Name</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('deleteStore', ['id' => $admin->id]) }}" method="POST"
