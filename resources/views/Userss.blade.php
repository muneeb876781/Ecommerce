...
<body>
    ...
    <div class="content-start transition  ">
        <div class="container-fluid dashboard">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 40%">
                                                <a class="btn btn-link text-primary" href="#" title="View Details"
                                                    ...
                                                    onclick="showUsersDetails('{{ $user->name }}', '{{ $user->email }}', '{{ $user->role }}')">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a class="btn btn-link text-warning" href="#" title="Edit"
                                                    data-bs-toggle="modal" data-bs-target="#editUserModal"
                                                    onclick="prepareEditUserModal('{{ $user->id }}', '{{ $user->name }}', '{{ $user->email }}',  '{{ $user->role }}')">
            ...
            <div id="seller" class="col-md-12" style="display: none;">
                <div class="card">
                    <div class="card-header">
                        <h4>Sellers</h4>
                    </div>
            ...
            <div id="admin" class="col-md-12" style="display: none;">
                <div class="card">
                    <div class="card-header">
                        <h4>Sellers</h4>
                    </div>
