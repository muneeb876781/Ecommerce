                ...
                <div class="card-body">
                    ...
                    <article class="card">
                        <div class="card-body row">
                            ...
                            <div class="col"> <strong>Shipping BY:</strong> <br> TCS, | <i
                                    class="fa fa-phone"></i> +1598675986 </div>
                            <div class="col"> <strong>Status:</strong> <br> {{$trackOrders->order_status}} </div>
                            <div class="col"> <strong>Tracking #:</strong> <br> {{$trackOrders->tracking_number}} </div>
                        </div>
                    </article>
                    <div class="track">
                        @php
                        ...
                        @foreach ($trackOrders->items as $orderitems)
                            <li class="col-md-4">
                                <figure class="itemside mb-3">
                                    <div class="aside"><img src="{{ asset($orderitems->image_url) }}"
                                            class="img-sm border">
                                    </div>
